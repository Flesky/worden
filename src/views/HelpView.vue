<template>
  <BaseDialog>
    <div id="help">
      ...
      ></BoardRowComponent>
      <p class="mt-2">
        The letter <span class="font-bold">B</span> is in the word and in the
        correct spot.
      </p>
      <BoardRowComponent
        :word="[
          { letter: 'A' },
          { letter: 'C', evaluation: 'present' },
          { letter: 'U' },
          { letter: 'T' },
          { letter: 'E' },
        ]"
      ...
      ></BoardRowComponent>
      <p class="mt-2">
        The letter <span class="font-bold">C</span> is in the word but in the
        wrong spot.
      </p>
      <BoardRowComponent
        :word="[
      ...
      <h2 class="mt-8">Hard mode</h2>
      <p class="mt-3">
        Be careful! In hard mode, invalid guesses count towards your guesses
        while not revealing any tiles.
      </p>
      <!--    <p class="mt-3">-->
